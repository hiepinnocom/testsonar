...
class SalesOrder extends CRMEntity {
	...
	function save_module($module)
	{
		...
		if($_REQUEST['action'] != 'SalesOrderAjax' && $_REQUEST['ajxaction'] != 'DETAILVIEW'
				...
				// https://redmine.innocom.vn/issues/16 -START
				&& $_REQUEST['action'] != 'GiftApprove' && $_REQUEST['action'] != 'GiftCheck' && $_REQUEST['action'] != 'GiftDelivery'
				// https://redmine.innocom.vn/issues/16 -END
